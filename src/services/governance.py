"""
Governance Engine — Demand-Supply Matching
============================================
Tier 1: Automated rule-based classification (auto-approve / flag / escalate).
...
class Tier1Governance:
    """Automated risk classification and routing."""
    ...
    def run(self, agent_results: dict[str, list[dict]]) -> dict:
        ...
        return {
            "tier": 1,
            "tier_name": "Automated Governance",
            "timestamp": now,
            "summary": {
...
class Tier2Governance:
    """Human-in-the-loop review for escalated critical items."""
    ...
    def run(self, tier1_output: dict) -> dict:
        ...
        return {
            "tier": 2,
            "tier_name": "Human Intervention Review",
            "timestamp": now,
            "summary": {
                "total_reviewed": len(escalated),
                "approved_urgent": len(approved),
                "conditionally_approved": len(conditional),
