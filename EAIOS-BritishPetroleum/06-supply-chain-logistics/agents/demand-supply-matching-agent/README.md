...
## Purpose
Balances product supply with downstream demand across BP's portfolio. Optimises crude acquisition, refinery runs, and product movements to minimise supply gaps and excess inventory.
...
`agent/demand-supply-matching-agent`
