...
## Purpose
Manages the full contractor lifecycle including onboarding, competency verification, permit-to-work compliance, performance tracking, and offboarding.
...
`agent/contractor-management-agent`
