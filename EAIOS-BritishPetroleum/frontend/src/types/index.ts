...
export const APPLICATIONS: Application[] = [
  ...
  { id: 'refiner-ai',                      name: 'RefAIne',                      description: 'Predictive Maintenance Intelligence Platform monitoring 6,842 assets across 40 global refineries.',               domainId: '05-manufacturing-plant-operations', status: 'active', version: '1.0.0', url: '/apps/refiner-ai', category: 'AI-Powered'   },
