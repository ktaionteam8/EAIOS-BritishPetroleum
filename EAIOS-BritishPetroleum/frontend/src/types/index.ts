...
export const APPLICATIONS: Application[] = [
  ...
  { id: 'environmental-reporting',          name: 'Environmental Reporting',          description: 'Capture emissions, waste, and energy data for regulatory compliance reporting.',                            domainId: '02-human-resources-safety', status: 'active', version: '1.0.0', category: 'Analytical'    },
